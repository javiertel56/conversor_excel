...
def transformar_excel(ruta_entrada, ruta_salida):
    ...
    keywords_map = {
        'Parque': ['f6par'], #agregar parque si es necesario
        'Norte': ['sexta norte'],
        'Palacio': ['palacio'],
        'Sendero': ['fsend'],
        'Galeria': ['fgale'],
...
class App:
    def __init__(self, root):
        self.root = root
        self.root.title("📊 Transformador Excel - Rosa Marcela")
    ...
    def build_ui(self):
        tk.Label(self.root, text="💼 Transformador Excel - T Comunicamos", font=("Helvetica", 22, "bold"), bg="#ecf0f1", fg="#2c3e50").pack(pady=20)
